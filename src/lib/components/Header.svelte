...
<Drawer width="w-5/6 md:w-1/2">
	<nav class="list-nav h-full p-4">
		<ul class="flex flex-col h-full gap-2">
			...
			<li><a href="/profile" on:click={drawerStore.close}>My Profile</a></li>
			<li>
				<button
					on:click={() => {
						goto('/entries/new');
